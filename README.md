...
- [World Wide Dishes csv](./data/WorldWideDishes_Main.csv)
- [World Wide Dishes Excel Sheet](./data/WorldWideDishes.xlsx)
...
- [Dishes selected for the five African countries + the US](./data/WorldWideDishes_Selected_Countries.csv)
- [US Test set csv](./data/WorldWideDishes_US_Test_Set.csv) (same set of dishes in the previous sheet, but also includes a regional label)
- [Dishes selected for the five African countries + the US / US Test set (Excel Sheet)](./data/WorldWideDishes.xlsx)
...
```
WWD_CSV_PATH=./data/WorldWideDishes_Main.csv
WWD_30_DISHES_CSV_PATH=./data/WorldWideDishes_Selected_Countries.csv
```
...
[Groq](https://groq.com) offers a fast and reliable API service for open-sourced LLMs, including Llama 3 models. As of June 2024, the Groq API was free to use. (However, the free version was removed since then.)
